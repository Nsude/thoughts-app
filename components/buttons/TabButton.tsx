    ...
    ${tabIcon1 ? 'rounded-[40px]' : 'rounded-[9px]'}`}>
      <button 
        onClick={(e) => {
          ...
          setTab(0); 
          handleClick(0); 
          if (handleTab1Click) handleTab1Click();
        }}
        className={`h-[3rem] flex justify-center items-center 
      ...
      <span ref={indicator} className={`
        my-tabIndicator absolute z-0 bottom-[3px] left-[3px] top-[3px] bg-myWhite outline-[2px] outline-myGray
